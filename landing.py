...
Most inputs have default values so you don't have to type out every single value, adjust as needed. This tool will be updated on a monthly basis when new stuff are released.
